...
<form action="/dataDictionaryItem/saveOrUpdate.do" method="post" id="editForm">
    ...
    <div class="modal-body" style="text-align:center"><font style="vertical-align: inherit; text-align: center"><font
        ...
        <table style="margin-left: 10px">
            ...
            <tr>
                <td>&nbsp;&nbsp;字典明细简介&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td style="padding:20px 0px"><input type="text" name="intro" value="${entity.intro}"></td>
            </tr>
            <c:if test="${entity.id==null}">
                <input type="hidden" name="parent.id" value="${param.sid}">
            </c:if>
            <c:if test="${entity.id!=null}">
                <input type="hidden" name="parent.id" value="${entity.parent.id}">
             </c:if>
        </table>
