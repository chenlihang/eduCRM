                ...
                $("#editForm").ajaxSubmit(function (data) {
                    if(data.success){
                        ...
                        showDialog("操作成功",function () {
                            window.location.href="/dataDictionaryItem/view.do";
                        })
                    }
                })
            });
...
<form id="searchForm" action="/dataDictionaryItem/view.do" method="post">
    ...
    <div>
        ...
        <a href="/dataDictionary/view.do" class="btn btn-default"><i class="fa fa-reply"></i>返回字典表</a>
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${result.data}" var="entity" varStatus="num">
                <tr>
                    ...
                    <td>${entity.intro}</td>
                    <td>
                        <a href="/dataDictionaryItem/input.do?id=${entity.id}" class="btn btn-default btn_dictionedit" data-url="/dataDictionaryItem/input.do?id=${entity.id}" data-toggle="modal" data-target="#myModal3"><i class="fa fa-edit"></i>编辑</a>
                        <a href="javascript:;" class="btn btn-default btn_dictionarydelete" data-url="/dataDictionaryItem/delete.do?id=${entity.id}"><i class="fa fa-minus"></i>删除</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
